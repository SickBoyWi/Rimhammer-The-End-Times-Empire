    ...
    public class CaravanArrivalAction_EnterMap : CaravanArrivalAction_Enter
    {
        ...
        public virtual void DoEnter(Caravan caravan)
        {
            ...
            if (num != 0)
            {
                ...
                Find.LetterStack.ReceiveLetter("RH_TET_Empire_CaravanArrivedAt".Translate() + " " + this.Label, stringBuilder.ToString(), LetterDefOf.NeutralEvent, (string)null);
            }
            else
                Find.LetterStack.ReceiveLetter("RH_TET_Empire_CaravanArrivedAt".Translate() + " " + this.Label,
