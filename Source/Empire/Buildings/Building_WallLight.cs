...
{
    public class Building_WallLight : Building
    {
        private Thing glower;
        private TheEndTimes_Empire.WallLightGlower wallGlower;
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            if (this.glower == null)
                ...
                this.wallGlower = (WallLightGlower)this.glower;
            StaticWallLightStuff.lastRoom = (Room)null;
        ...
        private void SpawnGlower()
        {
            ...
            this.wallGlower = (TheEndTimes_Empire.WallLightGlower)this.glower;
        ...
        private void DespawnGlower()
        {
            ...
            this.wallGlower = (WallLightGlower)null;
        }
        ...
        {
            this.defStr = "RH_TET_Empire_WallLightGlower";
            this.moteStr = "RH_TET_Empire_WallLight_On";
