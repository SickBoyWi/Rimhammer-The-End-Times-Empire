...
{
    public static class StaticWallLightStuff
    {
        ...
        public static void GetLightCells(IntVec3 pos, Map map)
        {
            ...
            RegionTraverser.BreadthFirstTraverse(region, (RegionEntryPredicate)((from, r) => r.door == null), (RegionProcessor)(r =>
            {
                ...
                {
                    if (cell.InHorDistOf(pos, StaticWallLightStuff.displayRad) && !StaticWallLightStuff.totalCells.Contains(cell))
                        StaticWallLightStuff.totalCells.Add(cell);
                }
                return false;
            }), 13, (RegionType)6);
        }
        ...
        {
            StaticWallLightStuff.totalCells.Clear();
        }
    }
}
